...
if __name__ == '__main__':
    ...
    power_stat = DiagnosticStatus(name = 'Power board 1000', level = DiagnosticStatus.OK, message = 'Running')
    power_stat.values = [ KeyValue(key = 'Runstop hit', value = 'False'), KeyValue(key = 'Estop hit', value = 'True') ]
    # Fake EtherCAT Master status, all OK
    eth_stat = DiagnosticStatus(name='EtherCAT Master', level = DiagnosticStatus.ERROR, message = 'Motors Halted')
